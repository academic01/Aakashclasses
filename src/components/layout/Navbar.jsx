          ...
          <div className="flex justify-between items-center w-full">
            ...
            <div className="hidden lg:flex items-center gap-4">
              ...
              <div className="flex items-center gap-3 mr-2 px-3 py-1 border-r border-[#E5E5E5]">
                 <a href="https://whatsapp.com/channel/0029VbBtlgEDTkKD76Beca16" target="_blank" rel="noopener noreferrer" className="w-[36px] h-[36px] rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all text-[#25D366] fill-white" title="Join WhatsApp Channel">
                    <WhatsappIcon className="w-5 h-5 text-white stroke-none fill-white" />
                 </a>
                 <a href="https://www.instagram.com/aakashacademics?igsh=MTNxMzdpazZ3dXE4cg==" target="_blank" rel="noopener noreferrer" className="w-[36px] h-[36px] rounded-full bg-gradient-to-tr from-[#f09433] via-[#e6683c] to-[#bc1888] text-white flex items-center justify-center shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all" title="Follow Instagram">
