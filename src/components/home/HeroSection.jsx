      ...
      <div className="hero-grid">
        ...
        <div className="right-column">
          ...
          <div className="hidden lg:block">
            <div className="absolute top-[10%] left-[20px] z-[3] flex items-center gap-[10px] bg-[rgba(13,34,64,0.75)] backdrop-blur-[16px] border border-[rgba(255,255,255,0.15)] rounded-[14px] p-[12px_16px] shadow-[0_12px_32px_rgba(0,0,0,0.3)] animate-float" style={{ animationDelay: '0s' }}>
